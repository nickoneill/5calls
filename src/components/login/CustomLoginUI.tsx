...
> {
  ...
  loginModalMarkup = () => {
    if (this.state.shouldDisplayLoginModal) {
      return (
        <span>
          <div className="login-modal-mask" onClick={this.toggleModal}>
            &nbsp;
          </div>
          <div className="login-modal">
            <div className="login-header">
              <p className="login-header-explainer">
                Track your calls, join call teams and see your impact on issues
                you care about!
              </p>
              {this.showCampaignLogo() ? (
                <div className="login-header-logo">
                  <a href={this.props.auth0Config.poweredURL} target="_blank">
                    <img
                      className="stars"
                  ...
                  <p className="login-header-logo-powered">
                    Powered by <strong>5 Calls</strong>
                  </p>
                </div>
              ) : (
                <span />
            ...
            <div className="login-choices">
              ...
              <div className="btn-block">
                <a className="button-cancel" onClick={this.toggleModal}>
                  Cancel
                </a>
              </div>
            </div>
  ...
  emailTextOrError = (): String => {
    if (
      this.state.emailIsValid === undefined ||
    ...
    return (
      <span>
        <div className="userHeader">
          ...
          <p>
            <a onClick={this.showLoginModal}>
              {this.props.profile ? this.props.profile.name : 'Log in'}
            </a>
          </p>
